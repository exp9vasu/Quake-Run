		...
		Pass {
			...
			Program "vp" {
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    u_xlat0.xyz = dFdx(vs_TEXCOORD0.xyz);
					    u_xlat1.xyz = dFdy(vs_TEXCOORD0.xyz);
					    u_xlat0.xyz = abs(u_xlat0.xyz) + abs(u_xlat1.xyz);
					    u_xlat0.x = dot(u_xlat0.xyz, vec3(1.0, 1.0, 1.0));
					    u_xlat0.x = u_xlat0.x / _NormalThreshold;
					    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
					    SV_Target0 = u_xlat0.xxxx * _Colors;
					    return;
					}
				...
				SubProgram "gles3 hw_tier00 " {
					...
					void main()
					{
					    ...
					    SV_Target0 = u_xlat0.xxxx * PropsArray[u_xlati2]._Colors;
					    return;
					}
